        ...
        <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
            ...
            <div className='my-4'>
                <div className='flex flex-col sm:flex-row items-center justify-between w-full gap-3'>
                    <input data-aos="fade-up" className='p-3 flex w-full rounded-md text-black border-black' type="email" placeholder='Enter Email' />
                    <button data-aos="fade-up" className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 md:mx-0 mx-auto py-3 hover:bg-gray-200 hover:text-black'>Notify Me!</button>
                </div>
